...
class SyntheticDataset(Dataset):
    def __init__(self, data_path, split, tasks, split_ratio=(0.9, 0.05, 0.05)):
...
class SyntheticTestDataset(SyntheticDataset):
    def __init__(self, data_path, split, tasks, task_blocks, split_ratio=(0.8, 0.1, 0.1), target_size=1000,
                 context_size=10, gamma=0.5, seed=0):
        '''
